...
- 【2026-09-03 再設定】`scripts/build_revenue_plan.py` で「売上目標_再設定_2026-09.xlsx」
  ...
  モデル: 自然売上＝前年同月×(1−前年広告比率15%)×成長率、広告売上＝広告費×想定ROAS
  ×月別ROAS達成度÷1.1。標準 3.04億 / 保守 2.72億 / 強気 3.24億。9月のROAS達成度0.7、
  10月0.85（9/1〜3実績ROAS3.3を反映）。10月(−620万)と12月(−261万)が予算未達月。
  月次チェックシートに実績を入れると2.8億までの残り必要額が出る。
