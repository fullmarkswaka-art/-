...
## 売上目標（FY2026 = 2026-05〜2027-04）

- 年商目標: 3.2億円（最低ライン2.8億円）。4ストア合計＋自然売り込み。
- 5〜8月実績: 8,910万（前年同期比147%）。9〜4月に必要なのは2.31億
  ＝過去2年の同期間平均(+0.5%)なので、例年並みの秋冬で達成できる。
- 月別目標はExcel「広告予算計画_2026-05_2027-04_金額確定版.xlsx」の
  「売上計画」シート参照。勝負月は2月冬セール（目標5,110万）と
  10月（昨年弱かった月。3ストア立ち上げ＋広告増額で挽回）。
- HOUDINI/NORRONA/PUの3ストアで4,000万（大半はFULLMARKSからの移管）。
- EC全体の売上実績はAPIで取れないため、月次でユーザーからCSVをもらい
  売上計画シートと突き合わせる。
